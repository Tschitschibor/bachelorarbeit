...
\makeatother
\let\olddottedarrow\dottedarrow
\renewcommand{\dottedarrow}{\raisebox{-.2em}{\olddottedarrow}}
...
\input{tex/en/Finite_concrete_categories.tex}
...
%\input{tex/en/Big_CatReps_Example.tex}

\input{tex/en/CatReps_algorithms.tex}
