...
An \ul{additive category} is an Ab-category $\mathcal{A}$ together with a dependent function $\oplus^{\mathcal{A}}$ mapping
a finite set $I$ and a family $(A_{i})_{i\in I}$ of objects in $\mathcal{A}$ to a corresponding direct sum $(\oplus_{i\in I}^{\mathcal{A}} A_{i},
...
\begin{example}{(Binary equalizer of two morphisms)}
Let $A, B \in \mathcal{C}_{0}$ and $f, g : A \rightrightarrows B \in \mathcal{C}_{1}$. The \ul{equalizer} of that diagram is the limit
\begin{itemize}
\item 
