...
finally Abelian category, each time giving constructive algorithms for that doctrine in $\kmat$. This whole section is a 
citation from \cite{[Posur]}, I.1.38-I.1.47 and I.2.
...
Section 4 now is the synthesis of chapters 2 and 3, in that we define the category of representations $\CatReps$
...
The last two sections deal with the hom-structure of our functor category $\HomAkmat$. In section 6 we give
...
In section 7 we give hom-based invariants that distinguish between different objects in our functor category, which provide 
...
pre-package \texttt{catreps} into the categorical framework offered by \CAP. Since the category of representations is
just an application of the package \FunctorCategories, the entire functionality of \texttt{catreps} including the code developed
in this thesis, is now available through \FunctorCategories.
