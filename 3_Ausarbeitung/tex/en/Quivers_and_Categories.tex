...
\begin{definition}{(Path algebra)}\label{def:path_algebra}
TODO
\end{definition}
...
\begin{definition}{(The functor category)}\endnote{(cited from ncatlab \cite{[ncatlab_functor_category]})}\\
