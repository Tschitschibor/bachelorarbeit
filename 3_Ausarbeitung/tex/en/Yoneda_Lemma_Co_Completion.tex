...
\subsubsection{Abelian categories with enough projectives objects (constructively)}
...
\begin{doctrine}[Abelian category with enough projective objects]
The doctrine $\mathtt{IsAbelianCategoryWithEnoughProjectives}$ therefore involves algorithms of $\mathtt{IsAbelianCategory}$
together with algorithms for
\begin{itemize}
...
\begin{doctrine}[Abelian category with enough injective objects]
The doctrine $\mathtt{IsAbelianCategoryWithEnoughInjectives}$ therefore involves algorithms of $\mathtt{IsAbelianCategory}$
together with algorithms for
\begin{itemize}
\item $\mathtt{EpimorphismFromSomeProjectiveObject}$,
\item $\mathtt{ProjectiveLift}$,
