...
\begin{tikzcd}
	& P \arrow[d, "\psi\varphi"] \arrow[ld, "\psi"', dotted] \\
...
$\textup{Hom}(P,\varphi) : \textup{Hom}(P,M) \rightarrow \textup{Hom}(P,N)$, given by $\rho \mapsto \varphi\rho\, \forall \rho \in \textup{Hom}(P,M)$.
%with $\textup{Hom}(P,s(\varphi)) = s( \textup{Hom}(P,\varphi) )$ and likewise $\textup{Hom}(P, t(\varphi)) = t( \textup{Hom}(P,\varphi))$.
...
$\textup{Hom}(P,\gamma) : \textup{Hom}(P,N) \rightarrow \textup{Hom}(P,O)$ and
$\textup{Hom}(P,\varepsilon) : \textup{Hom}(P,N) \rightarrow \textup{Hom}(P,O)$ and
...
$\forall \rho \in \textup{Hom}(P,M)$, $\rho(\varphi\gamma) = \rho(\varphi\varepsilon)$. Since $\phi$ is epi, it follows that
$\rho\gamma = \rho\varepsilon$ and therefore $\textup{Hom}(P,\gamma) = \textup{Hom}(P,\varepsilon)$, i.e.
$\textup{Hom}(P,\varphi)$ is epi.
