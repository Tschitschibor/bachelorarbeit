...
\end{lemma}
\begin{proof}
We have to show that $\mathrm{Hom}_{\mathcal{A}}(Y(i),-) = \mathrm{Hom}_{\mathcal{A}}(\mathrm{Hom}_{\mathcal{A}}(-,i),-)$ is exact.\\
Let $F,G \in \HomAkmat$ and $\varphi : F \twoheadrightarrow G$ an epi. For exactness of
$\mathrm{Hom}_{\mathcal{A}}(\mathrm{Hom}_{\mathcal{A}}(-,i),-)$ we have to show that
$\mathrm{Hom}_{\mathcal{A}}(\mathrm{Hom}_{\mathcal{A}}(-,i),\varphi) : \mathrm{Hom}_{\mathcal{A}}(\mathrm{Hom}_{\mathcal{A}}(-,i),F) \rightarrow \mathrm{Hom}_{\mathcal{A}}(\mathrm{Hom}_{\mathcal{A}}(-,i),G)$ defined by 
$\rho \mapsto \rho\varphi\, \forall \rho \in \mathrm{Hom}_{\mathcal{A}}(\mathrm{Hom}_{\mathcal{A}}(-,i),F)$ is also an epi.\\
For two parallel morphisms $\mathrm{Hom}_{\mathcal{A}}(\mathrm{Hom}_{\mathcal{A}}(-,i),\psi), \mathrm{Hom}_{\mathcal{A}}(\mathrm{Hom}_{\mathcal{A}}(-,i),\theta) : \mathrm{Hom}_{\mathcal{A}}(\mathrm{Hom}_{\mathcal{A}}(-,i),G) \rightrightarrows \mathrm{Hom}_{\mathcal{A}}(\mathrm{Hom}_{\mathcal{A}}(-,i),H)$
with $\rho\varphi\psi = \rho\varphi\theta$ we already have $\psi = \theta$?
\end{proof}
