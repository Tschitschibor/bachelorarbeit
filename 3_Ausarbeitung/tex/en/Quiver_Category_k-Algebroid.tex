...
\section{The categories Quiv, Cats, FinSets, k-Mat, CatReps and the Functor Category}
...
The images under $q$ ofthe morphisms $s$ and $t$ are again denoted by $s$ and $t$.
\end{definition}
